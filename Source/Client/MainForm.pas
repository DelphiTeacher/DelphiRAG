...
//  {$ENDIF IOS}
  ...
  System.Notification, FMX.StdCtrls,
  uTimerTaskEvent, uSkinLabelType, uSkinFireMonkeyLabel;//uSDKVersion;
...
type
  ...
  public
    ...
    //IOS下点击推送
    procedure DoBasePushIOSRecvAPNSNotification(Sender:TObject;ANotification:String;AIsAtBackground:Boolean;AIsStartup:Boolean;AForm:String);virtual;
    //Android下点击推送
    ...
    //点击推送后触发的事件
    procedure ClickPushNotification(Sender:TObject;ATitle:String;ABody:String;APayload:String;AIsAtBackground:Boolean;AIsStartup:Boolean;ATaskId:String);virtual;
  protected
...
procedure TfrmMain.DoBasePushIOSRecvAPNSNotification(Sender: TObject;ANotification: String;AIsAtBackground:Boolean; AIsStartup: Boolean;AForm:String);
var
...
procedure TfrmMain.DoMainProgramSettingCustomProcessPageAction(Sender: TObject;
  APageInstance: TObject; AAction: String;
...
procedure TfrmMain.ClickPushNotification(Sender:TObject;ATitle:String;ABody:String;APayload:String;AIsAtBackground:Boolean;AIsStartup:Boolean;ATaskId:String);
//var
//  AUserCustomJson:ISuperObject;
begin
...
//  tmrTestGPSLocation.Enabled:=False;
  ...
  if GlobalGPSLocation<>nil then
  begin
      GlobalGPSLocation.Longitude:=GlobalGPSLocation.Longitude+Self.tbDistance.Value*OneMeter;
      GlobalGPSLocation.Latitude:=GlobalGPSLocation.Latitude+Self.tbDistance.Value*OneMeter;
