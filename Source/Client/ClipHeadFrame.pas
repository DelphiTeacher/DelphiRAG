...
begin
  OutputDebugString('OrangeUI TFrameClipHead.imgOriginGesture');
  ...
  begin
      ...
      begin
        OutputDebugString('OrangeUI TFrameClipHead.imgOriginGesture Begin');
...
//      end;
      ...
      begin
        OutputDebugString('OrangeUI TFrameClipHead.imgOriginGesture End');
...
begin
  ...
  Result.SetSize(FHeadWidth,FHeadHeigth);
