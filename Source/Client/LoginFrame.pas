...
//    if Self.edtCaptcha.Text='' then
  ...
  else if (Const_APPLoginType=Const_RegisterLoginType_UserName_PassWord) then
  begin
    //邮箱
    FLoginType:=Const_RegisterLoginType_UserName_PassWord;
  end
  else
  begin
...
//  Self.lvThirdLogin.Visible:=lvThirdLogin.Prop.GetContentWidth>1;
  Self.lblThirdLogin.Visible:=lvThirdLogin.Prop.GetContentWidth>1;
