...
var
  ACode:Integer;
begin
  Result:=GetRecordList(Self.DBModule,nil,
...
var
  ACode:Integer;
begin
  Result:=GetRecord(Self.DBModule,nil,
                       ALoadDataSetting.AppID,
                       //查询条件,Json数组
                       ALoadDataSetting.WhereKeyJson,
                       //自带的Where条件
            ...
            begin
              ...
              begin
                  ...
                  begin
                    ...
                    if SameText(ASQLDBHelper.DBType,'PostgreSQL') then
                    begin
                      ASelectAfterInsert:='SELECT * FROM '+TableName+' WHERE '+PKFieldName+'=currval('''+TableName+'_'+PKFieldName+'_seq'')';
                    end;
...
//                        +'('+Select.Text+ATempWhere+') Z ',
              ...
              begin
                  ...
                  ADataJson.I['PageSize']:=APageSize;
                  ADataJson.I['PageCount']:=Ceil(ASumCount/APageSize);
                  ADataJson.I['PageIndex']:=APageIndex;
          ...
          begin
            ...
            begin
                ...
                if AIndex>0 then
                begin
                  ASelect:=Copy(ASelect,AIndex,MaxInt);
                  ASelect:='SELECT '+AGroupBySummary+' '+ASelect;
                end;


                AGroupBy:=' GROUP BY '+AGroupBy+' ';
...
begin
  ...
  if not Self.GetRecordList(ADBModule,ASQLDBHelper,AAppID,1,MaxInt,
                            GetWhereConditions(AFieldNameArray,AFieldValueArray),
                            '','',0,0,'',0,ACode2,ADesc2,ADataJson2) then
  begin
    ADesc:=ADesc2;
    Exit;
  end;
...
//  end;
  ...
  ACommonRestIntfItem.GetRecord(ACommonRestIntfItem.DBModule,nil,ALoadDataSetting.AppID,ALoadDataSetting.WhereKeyJson,'','',ACode,ADataIntfResult.Desc,ADataIntfResult.DataJson);
...
//  end;
  ...
  ACommonRestIntfItem.GetRecordList(ACommonRestIntfItem.DBModule,nil,ALoadDataSetting.AppID,
                                      ALoadDataSetting.PageIndex,
                                      ALoadDataSetting.PageSize,
                                      ALoadDataSetting.WhereKeyJson,
                                      //orderby
